...
export default { API_USER_LOGIN, API_SCHEDULE_ALL, API_CLIENT_CLASS, API_USER_REGISTER, API_CLIENT_ALL, API_CLIENT, API_SCHEDULE, API_STATISTICS, API_USER_ME, API_USER, API_USER_ALL }